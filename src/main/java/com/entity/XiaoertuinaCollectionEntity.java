...
public class XiaoertuinaCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XiaoertuinaCollectionEntity() {

	}

	public XiaoertuinaCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "XiaoertuinaCollection{" +
            "id=" + id +
            ", xiaoertuinaId=" + xiaoertuinaId +
            ", yonghuId=" + yonghuId +
            ", xiaoertuinaCollectionTypes=" + xiaoertuinaCollectionTypes +

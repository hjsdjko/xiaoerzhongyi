 ...
 * @email
 */
@TableName("xiaoertuina_liuyan")
public class XiaoertuinaLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XiaoertuinaLiuyanEntity() {

	}

	public XiaoertuinaLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "xiaoertuina_liuyan_text")
    ...
    public String toString() {
        return "XiaoertuinaLiuyan{" +
            "id=" + id +
            ", xiaoertuinaId=" + xiaoertuinaId +
            ", yonghuId=" + yonghuId +
            ", xiaoertuinaLiuyanText=" + xiaoertuinaLiuyanText +

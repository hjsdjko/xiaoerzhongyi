...
public class XiaoertuinaLiuyanView extends XiaoertuinaLiuyanEntity implements Serializable {
	...
	public XiaoertuinaLiuyanView() {

	}

	public XiaoertuinaLiuyanView(XiaoertuinaLiuyanEntity xiaoertuinaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xiaoertuinaLiuyanEntity);

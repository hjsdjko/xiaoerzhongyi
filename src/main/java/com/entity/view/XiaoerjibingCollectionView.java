...
import com.entity.XiaoerjibingCollectionEntity;
...
public class XiaoerjibingCollectionView extends XiaoerjibingCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String xiaoerjibingCollectionValue;
	...
	public XiaoerjibingCollectionView() {

	}

	public XiaoerjibingCollectionView(XiaoerjibingCollectionEntity xiaoerjibingCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xiaoerjibingCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getXiaoerjibingCollectionValue() {
				return xiaoerjibingCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setXiaoerjibingCollectionValue(String xiaoerjibingCollectionValue) {
				this.xiaoerjibingCollectionValue = xiaoerjibingCollectionValue;
			}
